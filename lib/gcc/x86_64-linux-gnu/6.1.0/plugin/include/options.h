...
enum opt_code
{
  ...
  OPT_mavx512bw = 1207,                      /* -mavx512bw */
  OPT_mavx512cd = 1208,                      /* -mavx512cd */
  OPT_mavx512dq = 1209,                      /* -mavx512dq */
  OPT_mavx512er = 1210,                      /* -mavx512er */
  OPT_mavx512f = 1211,                       /* -mavx512f */
  OPT_mavx512ifma = 1212,                    /* -mavx512ifma */
  OPT_mavx512pf = 1213,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1214,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1215,                      /* -mavx512vl */
  OPT_mbionic = 1216,                        /* -mbionic */
  OPT_mbmi = 1217,                           /* -mbmi */
  ...
  OPT_minline_all_stringops = 1247,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1248,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1249, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1250,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1251,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1252,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1253,                /* -mlong-double-80 */
  OPT_mlwp = 1254,                           /* -mlwp */
  OPT_mlzcnt = 1255,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1256,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1257,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1258,                  /* -mmitigate-rop */
  OPT_mmmx = 1259,                           /* -mmmx */
  OPT_mmovbe = 1260,                         /* -mmovbe */
  OPT_mmpx = 1261,                           /* -mmpx */
  OPT_mms_bitfields = 1262,                  /* -mms-bitfields */
  ...
  OPT_s = 1365,                              /* -s */
  OPT_s_bc_abi = 1366,                       /* -s-bc-abi */
  OPT_save_temps = 1367,                     /* -save-temps */
  OPT_save_temps_ = 1368,                    /* -save-temps= */
  OPT_shared = 1369,                         /* -shared */
  OPT_shared_libgcc = 1370,                  /* -shared-libgcc */
  ...
  OPT_static_libgcj = 1376,                  /* -static-libgcj */
  OPT_static_libgfortran = 1377,             /* -static-libgfortran */
  OPT_static_libgo = 1378,                   /* -static-libgo */
  OPT_static_liblsan = 1379,                 /* -static-liblsan */
  OPT_static_libmpx = 1380,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1381,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1382,               /* -static-libstdc++ */
  OPT_static_libtsan = 1383,                 /* -static-libtsan */
  OPT_static_libubsan = 1384,                /* -static-libubsan */
  /* OPT_std_c__03 = 1385, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1386, */                /* -std=c++0x */
  OPT_std_c__11 = 1387,                      /* -std=c++11 */
  OPT_std_c__14 = 1388,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1389, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1390, */                /* -std=c++1y */
  OPT_std_c__1z = 1391,                      /* -std=c++1z */
  OPT_std_c__98 = 1392,                      /* -std=c++98 */
  OPT_std_c11 = 1393,                        /* -std=c11 */
  /* OPT_std_c1x = 1394, */                  /* -std=c1x */
  /* OPT_std_c89 = 1395, */                  /* -std=c89 */
  OPT_std_c90 = 1396,                        /* -std=c90 */
  OPT_std_c99 = 1397,                        /* -std=c99 */
  /* OPT_std_c9x = 1398, */                  /* -std=c9x */
  OPT_std_f2003 = 1399,                      /* -std=f2003 */
  OPT_std_f2008 = 1400,                      /* -std=f2008 */
  OPT_std_f2008ts = 1401,                    /* -std=f2008ts */
  ...
  /* OPT_std_gnu89 = 1414, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1415,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1416,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1417, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1418, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1419,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1420, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1421, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1422, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1423,                     /* -std=legacy */
  OPT_symbolic = 1424,                       /* -symbolic */
  OPT_t = 1425,                              /* -t */
  OPT_time = 1426,                           /* -time */
  OPT_time_ = 1427,                          /* -time= */
  OPT_tno_android_cc = 1428,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1429,                 /* -tno-android-ld */
  OPT_traditional = 1430,                    /* -traditional */
  OPT_traditional_cpp = 1431,                /* -traditional-cpp */
  OPT_trigraphs = 1432,                      /* -trigraphs */
  OPT_u = 1433,                              /* -u */
  OPT_undef = 1434,                          /* -undef */
  OPT_v = 1435,                              /* -v */
  OPT_version = 1436,                        /* -version */
  OPT_w = 1437,                              /* -w */
  OPT_wrapper = 1438,                        /* -wrapper */
  OPT_x = 1439,                              /* -x */
  OPT_z = 1440,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
